...
mapabackground.src='/dragons/img/pueblo.jpg'
...
if(alturaQueBuscamos<80){
    alturaQueBuscamos=alturaQueBuscamos+70
}
...
//OBJETOS
let objChimuelo= new Dragon('Chimuelo','./img/chimuelo.png',5,'/dragons/img/chimueloMapa.png')
let objRompecraneos = new Dragon('Rompecraneos','./img/Vanidoso.png',5,'/dragons/img/Rompecraneos.png')
let objRatigueya = new Dragon('Ratigueya', './img/ratigueya.png',5,'/dragons/img/ratigueyaMapa.png')
                ...
                .then(function({enemigos}){
                    ...
                    dragonesEnemigos = enemigos.map(function(enemigo){
                        ...
                        if(dragonNombre === "Chimuelo"){
                            dragonEnemigo= new Dragon('Chimuelo','./img/chimuelo.png',5,'/dragons/img/chimueloMapa.png', enemigo.id)
                        }else if (dragonNombre === "Rompecraneos"){
                            dragonEnemigo = new Dragon('Rompecraneos','./img/Vanidoso.png',5,'/dragons/img/Rompecraneos.png', enemigo.id)
                        }else if(dragonNombre === "Ratigueya"){
                            dragonEnemigo = new Dragon('Ratigueya', './img/ratigueya.png',5,'/dragons/img/ratigueyaMapa.png', enemigo.id)
                        }
